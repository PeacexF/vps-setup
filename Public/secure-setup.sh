...
# !!! СОХРАНИТЬ И ДОБАВИТЬ SSH КЛЮЧИ ИЗ /root/.ssh/authorized_keys В НОВОГО ПОЛЬЗОВАТЕЛЯ, А ТАКЖЕ СОХРАНИТЬ ИХ ЛОКАЛЬНО У СЕБЯ, ИНАЧЕ МОЖНО ПРОЕБАТЬ ДОСТУП К СЕРВЕРУ !!!
